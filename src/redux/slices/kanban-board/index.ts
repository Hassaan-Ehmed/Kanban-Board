...
const kanbanSlice: any = createSlice({
  ...
  reducers: {
    ...
    _removeTaskFromBacklog: (state: any, action: any) => {
      ...
      let filteredArr = state.backlog_tasks.filter(
        (_: any, i: number) => i !== action.payload
      );

      let removeByBacklog = state.backlog_tasks.filter(
        (_: any, i: number) => i === action.payload
      );
    ...
    _removeTaskFromDoing: (state: any, action: any) => {
      let filteredArr = state.doing_tasks.filter(
        (_: any, i: number) => i !== action.payload
      );

      let removeByDoing = state.doing_tasks.filter(
        (_: any, i: number) => i === action.payload
      );
    ...
    _backToDoing: (state: any, action: any) => {
      let filteredArr = state.review_tasks.filter(
        (_: any, i: number) => i !== action.payload
      );

      let backToDoing = state.review_tasks.filter(
        (_: any, i: number) => i === action.payload
      );
    ...
    _goToDone: (state: any, action: any) => {
      ...
      let removeFromReview = state.review_tasks.filter(
        (_: any, i: number) => i === action.payload
      );
